...
<script>
  ...
  import CatalogFilter from '~/components/03-modules/filter/Filter.vue'
  import CatalogGridItem from '~/components/03-modules/catalog-grid-item/CatalogGridItem.vue'
